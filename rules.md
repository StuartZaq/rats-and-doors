...
<!-- !! добавить введение из vol 1 Introduction
Добавить в ГМбук PREPARATION FOR THE CAMPAIGN: из vol1-->
...
Однако он может произносить заклинания, а начинает игру с книгой заклинаний, содержащей заклинания 1-го круга. Для произнесения и поддержания заклинания, чародей не должен (пере)?!!двигаться и участвовать в ближнем бою.
...
Жрецы начинают игру с псалтырём, содержащим заклинания 1-го круга. Для произнесения и поддержания заклинания, жрец не должен (пере)!!??двигаться и участвовать в ближнем бою.
...
В подземных сооружениях дворфы могут обнаружить любые новые конструкции, смещения стен, полов, откосов, падающие плиты, фальшполы, люки и тому подобное.
