...
- Добавлена обложка
- Добавлен файл build_pdfs.sh, позволяющий одной командой собрать все pdf из всех md файлов
- В Потерю направления добавлена фраза о видимости в дикой местности.
- Для подлого удара сзади добавлен бонус на попадание
- В опциональные правила для игры без жреца добавлен список заклинаний, которые следует добавить в список заклинаний чародея
- Добавлены уточнения по простому использованию мировоззрений
- Уточнено, что подлый удар сзади можно делать только 1 раз за раунд вместо всех других атак
- Уточнена скорость в бою
- Добавлено оциональное правило по травмам вместо смерти
- Расширены правила по компаньонам

### Изменено

- Один файл разделён на несколько брошюр
- Общие настройки из yaml части вынесены в отдельные .yaml файлы
- Обновлены Благодарности и Введение
- Наёмники (солдаты) стали воинами, наёмниками стали воины, согласные спускаться в подземелья за плату
- В бою быстро сменить оружие можно не только с кинжала, но и на кинжал
- Изменены бонусы попадания с фланга и тыла
- Перенесены позиционные модификаторы к попаданию из Основных правил в Опциональные
- Боеспособность для мультиатаки заменена на КЗ, таблица Боеспособности перенесена в mass combat
- Изменено заклинание Защита у Чародея и Жреца
- Изменено заклинание Обнаружение невидимых у Чародея
- Изменено заклинание Обнаружение у Чародея и Жреца
- Изменено заклинание Защита, радиус 10 футов у Чародея и Жреца
- Изменено заклинание Развеивание у Жреца
- В опциональные правила перенесены правила по разрушениям от огненных шаров и молний
- Понятие врасплох унифицировано до внезапно
- Изменены правила по боевому духу
- Уточнены правила по Сообщникам
- Изменены уровни заголовков в Основных правилах, Книге рефери, Замках
- Часть правил перенесена из Основных правил в Книгу рефери

### Удалено
- Из таблицы бонусов и штрафов на попадание убраны бонусы, связанные с захватами

### В планах на ver.0.99

- В порядке бреда: убрать заклинания, монстров, сокровищ --- для побуждения придумывать всё это самостоятельно.

### В планах на ver.1.00

- Добавить иллюстрации от Георгия Мрачного

## [ver.0.97] - 2025-11-08

### Добавлено

- Добавлен раздел с сокращениями
- Бонус ловкости теперь влияет на проверки инициативы
- Харизма теперь влияет на реакцию встреченных
- Уточнено, как считать ОЗ при получении нового уровня
- Гномам добавлены ограничения по оружию
- Добавлены правила по шлемам
- Добавлены уточнения в Боеспособности
- Добавлены криты
- Всему оружию и всем монстрам добавлен Класс Оружия (КО)
- Добавлено описание урона без оружия
- Добавлены описания для всего оружия
- Добавлены правила по подлому удару сзади
- Добавлены правила по копированию заклинаний
- Двуручный меч с большим шансом наносит больший урон
- Добавлен способ определения количества встреченных монстров для подземелий
- Монстрам добавлены правила по спасброскам
- Нелюди теперь знают свой родной язык
- Добавлено уточнение по определению волшебных предметов
- Добавлен раздел с опциональными правилами
- В опциональные правила добавлено объяснение сторон глобального конфликта (мировоззрений)
- В опциональные правила добавлена возможность игры без жреца с обращением нежити любым классом
- В опциональные правила добавлены простые спасброски
- В опциональные правила добавлены правила по усталости
- В опциональные правила добавлены правила по построению

### Изменено

- Все упоминания мировоззрений перенесены в опциональные правила, а в прежних местах заменены по смыслу
- Жрец хаоса изменён на жреца-отступника
- Происхождение/предназначение мечей теперь является лишь опциональным правилом
- Гномы (гномики) перемещены в опциональные правила
- Дворфы --- теперь гномы
- Обнаружение ловушек и прочего у гномов --- теперь способность с известным шансом
- Уточнено описание эльфов, каким образом они совмещают 2 класса
- Изменены ограничения жрецов по оружию
- Изменены правила по мультиатаке для ПИ
- Изменены правила по боевому духу
- Изменены правила по лечению
- Выбивание дверей теперь открытие дверей с помощью силы
- Расы выделены из Классов в Расы
- Изменены формулировки по получению опыта
- Уточнены формулировки в описании чародея
- Уточнены правила по обращению нежити
- Уточнены правила по Компаньонам
- Уточнены правила по Наёмникам
- Изменены правила по подчинению
- Изменены бегство и погоня в подземелье
- Изменены правила по времени в бою
- Сильно изменены инициатива и бой
- Уточнены правила по постою и содержанию
- Таблица монстров разделена на две таблицы
- Добавлена опциональная возможность создавать свитки с 1-го уровня

### Удалено

- Из заклинаний жреца изъято упоминание извращённых версий заклинаний
- Убраны упоминания зла и добра
- Убраны бонусы за стрельбу на близком расстоянии
- Убрано древковое оружие

## [ver.0.96] - 2025-05-12

### Добавлено

- Уточнено, что всё оружие наносит к6 урона
- Возвращена мультиатака монстров
- Добавлен раздел Боеспособность
- Возвращена мультиатака персонажей

### Изменено

- Обновлены благодарности, добавлены основные тестировщики
- При найме монстров влияет значение харизмы, а не бонус

### Удалено

- Убрал пращу
- Убрал бонус реакции из харизмы
- Убрано ограничение жрецов на возможность изгнания нежити после провала

### Исправлено

- Исправлен ряд помарок
- Исправлено обращение нежити у жреца
- Исправлено оружие жрецов
- Исправлена стрельба у хоббитов
- Исправлен бонус ловкости
- Исправлено написание значений характеристик
- Исправить минимальную ставку в 100 зм для людей, а не бойцов
- Исправлено описание Спекторов и Вампиров
...
- Добавлены уточнения под таблицу монстров
...
- Изменено течение времени для морских битв - раунды стали ходами
...
- Изменил описание и бонусы характеристик в соответствии с оригиналом
...
- Изменил Внезапность
- Бандитам добавлено уточнение по экипировке
- Изменена скорость Кобольдов
- Скорости для моря и воздуха перемещены в Исследование дикой местности
- Дополнены правила по Потери направления в дикой местности
- YAML раздел в rules.md обновлён командами, убирая необходимость вводить их при формирование pdf-файла
...
- Убрал бонус к атаке от классового бонуса к КЗ у персонажей
...
- Убрал мультиатаку монстров
- Убрал мультиатаку персонажей игроков
...
- Для случайных столкновений, если размеры комнаты/коридора не позволяют разместить монстра на выпавшее расстояние, его можно разместить в ближайшей подходящей точке
...
- Все атаки в мультиатаке делаются с обычным бонусом на попадание, а первая атака делается ещё и с бонусом от классового КЗ
...
- Таблица с животными и транспортом сокращена, вследствие чего убраны и их описания
...
- Исправил грамматические ошибки, опечатки, помарки, формулировки (без потери смысла)
...
- Магические предметы стали волшебными
