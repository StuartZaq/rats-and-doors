...
- Изменить зачарованные стрелы на волшебные
- Добавить описание некоторых предметов в связи с тем, что исчезла колонка с весами
- Поправить "дрец" на "жрец"
- Убрать строчку(и) о скатке/спальнике
- Убрать правила о **Рыбалке**
- Оформить снятие паралича у Умертвий по подобию Призраков
...
- В описание Умертвий добавлена возможность некоторых классов/рас снимать наложенную умертвиями парализацию
...
- У дворфов больше не ограничения на скорость в 9''
