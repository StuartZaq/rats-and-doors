...
### В планах на ver.0.98

- Подумать над тем, чтобы опциональные правила из текста игры убрать в раздел опциональных правил
- Разделить правила на несколько книжек:
	- Основные правила, включающие генерёжку и всё, что может потребоваться игрокам
	- Рекомендации для рефери, а также таблицы бродящих монстров и сам монстрятник
	- Правила по гекскроулу и замкам, воздушным и морским путешествиям. Сюда же --- опциональные правила.
- Добавить остальные иллюстрации от Георгия Мрачного
