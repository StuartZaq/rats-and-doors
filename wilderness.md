...
Каждый день есть шанс потеряться, зависящий от типа местности, из которой стартуют персонажи. Потерявшаяся группа сместит направление своего движение в сторону, выпавшую на **к6**, где **\<\<1\>\>** это север, и дальше по часовой стрелке. Ведущий озвучивает, в какую сторону движется группа, а персонажи могут скорректировать курс на 1 шаг. *Например, персонажи стартуют на равнине и хотят на лёгких лошадях (скорость 24'' или 8 гексов в день) двигаться строго на север (3 гекса), а затем на северо-запад, по пути в крепость (ещё 5 гексов). Бросок показал, что они потерялись на равнине и должны двигаться на юг. Группа корректирует курс и будет в итоге двигаться на юго-запад на максимальную дистанцию, которую могут пройти (8 гексов).
